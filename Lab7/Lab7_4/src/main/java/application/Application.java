...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Find the list of students whose name contains the word "Smith"
		System.out.println("Students whose name contains the word 'Smith':");
		Iterable<Student> studentsByNameContaining = studentRepository.findByNameContainingIgnoreCase("Smith");
